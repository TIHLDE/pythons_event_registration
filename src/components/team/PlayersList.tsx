...
import ChangePositionModal from 'components/team/ChangePositionModal';
import ChangeTeamModal from 'components/team/ChangeTeamModal';

export type PlayersListProps = {
  title: string;
  players: PlayerProps['player'][];
};

export type PlayerProps = {
  player: Pick<Player, 'id' | 'name' | 'positionId' | 'teamId'>;
};
