  ...
  return (
    <>
      ...
      <p className='text-md my-4 whitespace-break-spaces'>
        {`Spillerne her synkroniseres automatisk med personene som er med i TIHLDE Pythons sin gruppe på TIHLDE.org. Det betyr at for å legge til en ny spiller her, så må du leder legge til personen på TIHLDE.org først, synkroniseringen skjer automatisk hver hele time. Du kan synkronisere selv ved å klikke på knappen på bunnen av siden. Eventuelle nye spillere uten lagtilhørighet vises nederst på siden.
